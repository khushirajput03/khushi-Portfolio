...
export const gridItems = [
  ...
  },
  {
    ...
    description: "",
    className: `lg:ml-0 lg:col-span-2  md:col-span-3 md:row-span-1 lg:row-span-2 md:w-[120vw] w-[88vw] h-[40vh] lg:ml-0 lg:w-[35vw] lg:h-[55vh]`,
    imgClassName: "",
...

  {
    ...
    className: `lg:ml-0 md:col-span-3 md:row-span-2 lg:w-[55vw] md:w-[60vw] md:h-[63vh] lg:h-[69vh] w-[88vw] h-[20vh]`,
