...
export const gridItems = [
  ...
  },
  {
    ...
    description: "",
    className: `lg:col-span-2  md:col-span-3 md:row-span-1 lg:row-span-2  md:ml-33 md:w-[120vw] w-[88vw] h-[40vh] ml-10 lg:ml-0 lg:w-[35vw] lg:h-[55vh]`,
    imgClassName: "",
  ...
  },
  {
    ...
    md:col-span-6 md:w-[120vw] md:ml-35 w-full h-auto min-h-fit w-[88vw] h-[40vh] ml-10 
    `,
    imgClassName: "",
  ...
  },
  {
    ...
    md:w-[55vw] md:h-[38vh] md:ml-35 w-[88vw] h-[20vh] ml-10
    `,
    imgClassName: "",
    titleClassName: "justify-start",
    img: "/grid.svg",
...

  {
    ...
    className: `md:col-span-3 md:row-span-2 lg:w-[55vw] md:w-[60vw] md:h-[63vh] lg:h-[69vh] md:ml-0 w-[88vw] h-[20vh] ml-10`,
  ...
  },
  {
    ...
    md:w-[55vw] md:h-[20vh] md:ml-35 w-[88vw] ml-10`,
    imgClassName: "",
