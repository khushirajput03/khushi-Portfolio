...
export const gridItems = [
  {
    ...
    description: "",
    className: `lg:col-span-3 md:col-span-6 lg:row-span-4 md:row-span-1 lg:h-[110vh] lg:w-[55vw]  md:w-[120vw] lg:ml-0
     w-[88vw] h-[40vh] sm:ml-10`,
  ...
  },
  {
    ...
    description: "",
    className: `sm:ml-10 lg:col-span-2  md:col-span-3 md:row-span-1 lg:row-span-2 md:w-[120vw] w-[88vw] h-[40vh] lg:ml-0 lg:w-[35vw] lg:h-[55vh]`,
    imgClassName: "",
  ...
  },
  {
    ...
    className: `sm:ml-10 lg:col-span-2 md:col-span-3 md:row-span-1 lg:row-span-2 lg:w-[35vw] lg:ml-0 lg:h-[50vh]
  ...
  },
  {
    ...
    description: "",
    className: `sm:ml-10 lg:col-span-2 md:col-span-3  lg:ml-0 lg:w-[35vw] lg:h-[25vh]
...

  {
    ...
    className: `sm:ml-10 md:col-span-3 md:row-span-2 lg:w-[55vw] md:w-[60vw] md:h-[63vh] lg:h-[69vh] w-[88vw] h-[20vh]`,
  ...
  },
  {
    ...
    description: "",
    className: `sm:ml-10 lg:col-span-2 md:col-span-3 lg:ml-0 lg:h-[40vh] lg:w-[35vw]
