...
export const gridItems = [
  ...
  },
  {
    ...
    description: "",
    className: `lg:ml-0 lg:col-span-2  md:col-span-3 md:row-span-1 lg:row-span-2 md:w-[120vw] w-full h-[20vh] lg:ml-0 lg:w-[35vw] lg:h-[55vh] `,
    imgClassName: "",
  ...
  },
  {
    ...
    md:col-span-6 md:w-[120vw]  w-full h-full h-[40vh] 
    `,
    imgClassName: "",
  ...
  },
  {
    ...
    md:w-[55vw] md:h-[38vh] w-full h-full
    `,
    imgClassName: "",
    titleClassName: "justify-start",
    img: "/grid.svg",
...

  {
    ...
    className: `lg:ml-0 md:col-span-3 md:row-span-2 lg:w-[55vw] md:w-[60vw] md:h-[63vh] lg:h-[69vh] w-full h-full`,
  ...
  },
  {
    ...
    description: "",
    className: `lg:ml-0 lg:col-span-2 md:col-span-3 lg:ml-0 lg:h-[40vh] lg:w-[35vw]
    md:w-[55vw] md:h-[20vh] h-full w-full`,
    imgClassName: "",
