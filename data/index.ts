...
export const gridItems = [
  ...
  },
  {
    ...
    description: "",
    className: `lg:ml-0 lg:col-span-2  md:col-span-3 md:row-span-1 lg:row-span-2 md:w-[120vw] w-[88vw] h-[40vh] lg:ml-0 lg:w-[35vw] lg:h-[55vh] md:mr-10`,
    imgClassName: "",
  ...
  },
  {
    ...
    md:col-span-6 md:w-[120vw]  w-full h-auto min-h-fit w-[88vw] h-[40vh] md:mr-10
    `,
    imgClassName: "",
  ...
  },
  {
    ...
    md:w-[55vw] md:h-[38vh] w-[88vw] h-[20vh] md:mr-10
    `,
    imgClassName: "",
    titleClassName: "justify-start",
    img: "/grid.svg",
