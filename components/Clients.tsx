...
const Clients = () => {
  return (
    <div
      className="py-20 w-full bg-black  overflow-x-hidden "
      id="skills"
    >
      {/* Animated Gradient Background */}
      <div className="inset-0 -z-10 bg-gradient-to-r from-blue-900 via-blue-600 to-indigo-700 animate-[gradientShift_15s_ease_infinite] bg-[length:300%_300%] opacity-20"></div>
      ...
      <div className="w-full max-w-7xl mx-auto px-4">
        <InfiniteMovingCards
          ...
          speed="fast"
          renderItem={(item) => (
            <div className="group flex mt-5 flex-col items-center justify-center cursor-pointer relative">
              {item.img && (
                <Image
                  src={item.img}
                  alt={item.name}
