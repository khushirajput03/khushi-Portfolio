...
const Footer = () => {
  return (
    <footer className="relative w-full pt-12 pb-6 md:pt-16 md:pb-8 lg:pt-20 lg:pb-10" id="contact">
      {/* Background Grid */}
      ...
      <div className="relative flex flex-col items-center text-center z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <a href="mailto:khushikhushi89978@gmail.com" className="w-full sm:w-auto max-w-xs sm:max-w-none">
          <MagicButton
            title="Let's get in touch"
            icon={<FaLocationArrow />}
            position="right"
            className="w-full text-xs sm:text-sm md:text-base px-4 py-2 sm:px-6 sm:py-3"
          />
        </a>
      </div>
